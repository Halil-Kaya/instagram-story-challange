...
export class StoryService {
    ...
    private async updatePagination(pagination: Pagination, query?: FindOptionsWhere<IStory>): Promise<void> {
        ...
        pagination.totalPageCount =
            pagination.totalItemCount == pagination.limit
                ? 0
                : Math.floor(pagination.totalItemCount / pagination.limit);
    }
}
